...
func schema_installer_apis_installer_v1alpha1_KubeformOperator(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/installer/apis/installer/v1alpha1.KubeformOperatorSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/installer/apis/installer/v1alpha1.KubeformOperatorSpec"},
	}
}

func schema_installer_apis_installer_v1alpha1_KubeformOperatorList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KubeformOperatorList is a list of KubeformOperators",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of KubeformOperator CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kubeform.dev/installer/apis/installer/v1alpha1.KubeformOperator"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/installer/apis/installer/v1alpha1.KubeformOperator"},
	}
}

func schema_installer_apis_installer_v1alpha1_KubeformOperatorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KubeformOperatorSpec is the schema for Kubeform Operator values file",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"nameOverride": {
						SchemaProps: spec.SchemaProps{
