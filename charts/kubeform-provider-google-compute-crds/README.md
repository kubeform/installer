# Kubeform Provider Google Compute CRDs
...
The following table lists the configurable parameters of the `kubeform-provider-google-compute-crds` chart and their default values.
...
```console
$ helm install kubeform-provider-google-compute-crds appscode/kubeform-provider-google-compute-crds -n kubeform --set operator.tag=v0.1.0
```
...
```console
$ helm install kubeform-provider-google-compute-crds appscode/kubeform-provider-google-compute-crds -n kubeform --values values.yaml
```
