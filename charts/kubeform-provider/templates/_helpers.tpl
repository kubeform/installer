...
*/}}
{{- define "kubeform-provider.fullname" -}}
...
*/}}
{{- define "kubeform-provider.chart" -}}
...
Common labels
*/}}
{{- define "kubeform-provider.labels" -}}
helm.sh/chart: {{ include "kubeform-provider.chart" . }}
{{ include "kubeform-provider.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "kubeform-provider.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kubeform-provider.name" . }}
...
*/}}
{{- define "kubeform-provider.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kubeform-provider.fullname" .) .Values.serviceAccount.name }}
{{- else }}
